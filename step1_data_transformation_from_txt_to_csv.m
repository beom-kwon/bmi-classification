...
% We unzipped the Kinect Gait Biometry Dataset at the folder "DB"
% Please modify PATH for your environment.
% After you unzip the dataset, the new folder "kinect gait raw dataset"
% will be generated
dataset_path_in = strcat(pwd,'\DB\kinect gait raw dataset\');
dataset_path_out = strcat(pwd,'\DB\kinect gait csv dataset\');
...
num_joints = 20; % Kinect v1 sensor provides 3D positions of 20 body joints
